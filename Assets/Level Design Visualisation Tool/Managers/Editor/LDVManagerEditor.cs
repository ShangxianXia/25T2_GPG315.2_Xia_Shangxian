...
[CustomEditor(typeof(LDVRulerManager))]
public class LDVManagerEditor : Editor
{
    private void OnSceneGUI()
    {
        LDVRulerManager ldvRulerManagerReference = (LDVRulerManager)target;
    ...
    private Texture2D FakingBorderWithTexture(int colourWidth, int colourHeight, Color aColourThatIsStored)
    {
